...
![png](images/decisionTrees1.png)
    

## Випадковий ліс (Random Forest) та Градієнтне підсилення (Gradient Boosting)
...
![png](images/decisionTrees2.png)
    

## Регресія за допомогою дерев
